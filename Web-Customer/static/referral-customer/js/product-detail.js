...
function styleItem (a,b,c) {
    a.style.cssText = 'color:#4654a5 ; border-bottom: 2px solid #4654a5 ; padding-bottom: 6px';
    b.style.cssText = 'color:#4654a5 ; border-bottom: none';
    c.style.cssText = 'color:#4654a5 ; border-bottom: none';
}
...
if(chooseInfo) {chooseInfo.addEventListener('click', event => {
